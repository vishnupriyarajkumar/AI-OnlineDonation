        ...
        <div className="dashboard-content">
          <div style={{ marginBottom:28 }}>
            <h1 style={{ fontSize:26, fontWeight:900 }}>
              🎯 Create <span className="gradient-text" style={{ background: 'linear-gradient(135deg, #06b6d4, #38bdf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Campaign</span>
            </h1>
            <p style={{ color:'var(--text-muted)', marginTop:4 }}>
              Register a new fundraising initiative to raise donations.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div style={{ display:'flex', justifyContent:'flex-end', gap:12, marginTop:8 }}>
                ...
                <button type="submit" className="btn btn-primary" disabled={loading}
                  style={{ minWidth:140, justifyContent:'center', background: 'linear-gradient(135deg, #06b6d4, #38bdf8)' }}>
                  {loading ? (
